...
<h2 class="header-block m-header-block-blue"><b class="bg-header-block-l"></b><b class="bg-header-block-r"></b><span class="header-block-i">Апошняе на сайце</span></h2>
...
{{list_articles length="5" constraints="type is article" order="bypublishdate desc" ignore_issue="true" ignore_section="true" }}
