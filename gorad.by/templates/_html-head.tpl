...
{{elseif $gimme->article->has_image(3)}}  <meta property="og:image" content="{{$gimme->article->image3->imageurl}}" />
{{elseif $gimme->article->has_image(4)}}  <meta property="og:image" content="{{$gimme->article->image4->imageurl}}" />
{{/if}}
{{/if}}
  ...
  <link rel="shortcut icon" href="http://{{$gimme->publication->site}}/templates/images/favico.ico" />
...
{{/list_sections}}
  <link rel="stylesheet" href="http://{{$gimme->publication->site}}/templates/css/{{if $gimme->template->name=="print.tpl"}}print.css{{else}}main.css?v={{ php }}echo filemtime($_SERVER['DOCUMENT_ROOT'].'/templates/css/main.css');{{ /php }}{{/if}}" type="text/css" />
{{*<!-- {{ php }}
...
{{ /php }} -->*}}
  ...
  <script>(function(d, s, id) {
    ...
    js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=146270388778911";
...
{{/if}}
  ...
  <meta name="msvalidate.01" content="67EAC5343C94A90AA2891D44C55C20F9" />
