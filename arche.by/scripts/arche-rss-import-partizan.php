...
$html = '<ul>';
$i = 0;
$xml = @simplexml_load_file("http://belaruspartisan.org/bp-forte/?page=1040&locale=be");
...
if ($xml) {
  ...
  $html .= '</ul>';
  if ( strlen($html) > 512) {file_put_contents("/var/www/xml-forest/arche-rss-import-partizan.html", $html);}
}
