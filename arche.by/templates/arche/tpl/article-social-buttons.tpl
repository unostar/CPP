{{assign var="data_url" value="http://`$gimme->publication->site`/`$gimme->language->code`/page/`$gimme->section->url_name`/`$gimme->article->number`"}}
<ul class="social-buttons">
  ...
  <li class="addthis">
    <div class="addthis_toolbox addthis_default_style" addthis:url="{{$data_url}}" addthis:title="{{$gimme->article->name}}" addthis:description="{{$gimme->article->intro|strip_tags:false|strip}}">
