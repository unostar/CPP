<section class="tabs emails">
  ...
  <div class="tab tab-visible">
    ...
    {{include file="video/tpl/sendmail.tpl" type="subscription"}}
    <p>Калі Вы больш не жадаеце атрымліваць нашу рассылку, проста націсьніце кнопку</p>
    <p class="center"><a href="{{url options="template video/tpl/sendmail.tpl"}}&type=subscription&topic=Карыстальнік жадае адпісацца" class="button sendmail_subscribe">Адпісацца</a></p>
  </div><!-- .tab -->
  <div class="tab">
    <p>Маеш, што напісаць нам, хочаш прыслаць сваё фота або відэа, ведаеш навіну?</p>
    <p class="center"><a class="button sendmail" href="{{url options="template video/tpl/sendmail.tpl"}}&type=editorial">Ліст рэдактару</a></p>
  </div><!-- .tab -->
</section><!-- .tabs emails -->
