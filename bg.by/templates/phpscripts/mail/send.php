...
$script_path = '/templates/phpscripts/mail/send.php';
...
$form_struct = '
  ...
  type=selrecip|class=fmselect|label=Послать|data=(выберите),Отправить письмо,203535@rambler.ru,Отправить новость,203535@rambler.ru,Отправить фото,203535@rambler.ru
  ...
  type=file|class=fmfile|label=Файл|fieldname=fm_upload|allowed=jpg,jpeg,gif,png,pdf,zip,rar,doc,docx
  type=closefieldset
';
