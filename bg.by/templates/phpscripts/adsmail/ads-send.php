...
$script_path = 'http://www.b-g.by/templates/phpscripts/adsmail/ads-send.php';
...
$form_struct = '
type=text|class=fmtext|label=Ф.И.О.|fieldname=fm_name|req=true|max=100
type=select|class=fmselect|label=Рубрика|fieldname=fm_rubric|req=true|data=(выберите),куплю,продам,сдаю,меняю,совсем даром,услуги,работа
type=textarea|class=fmtext|label=Адрес|fieldname=fm_address|req=true|max=1000|rows=4
type=text|class=fmtext|label=Телефон|fieldname=fm_phone|req=true|max=100
type=textarea|class=fmtext|label=Текст объявления|fieldname=fm_adstext|req=true|max=1000|rows=4
...
$sender_name = 'b-g.by';
$sender_email = 'robot@b-g.by';
$email_subject = 'Zakaz reklamy na sajte b-g.by';
