...
//mirovnie novosti
$rss_file = "http://today.rambler.ru/rss/Russia/world/";
...
case ($time[2] == "Dec" || $time[2] == "December"): $time[2] = "декабря"; break;
    ...
    $content .= "<p class=\"rss-link\"><a href=\"$item->link\" target=\"_blank\">$item->title ($time[1] $time[2] $time[3])</a></p>\n";
}

write($content, 'brest-feed-vmire.html');
