{{set_current_issue}}<rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom" xmlns:media="http://search.yahoo.com/mrss/">
<channel>
...
<atom:link href="http://{{$gimme->publication->site}}/index.rss" rel="self" type="application/rss+xml" />
{{list_articles length="20" constraints="type is article section smaller 100" ignore_issue="true" order="bypublishdate desc"}}
<item>
