...
$html_page_title = 'Рэгіянальная газета';
...
$form_struct = '
  ...
  type=selrecip|class=fmselect|label=Адправіць|data=(абярыце),Адправіць ліст,regionnews@promedia.by,Адправіць навіну,regionnews@promedia.by
