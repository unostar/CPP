...
$html_page_title = 'Падпiсацца на рассылку';
...
$form_struct = '
  type=openfieldset|legend=Падпiсацца на рассылку
  ...
  to=larysa.shapavalava@gmail.com
...
<script type="text/javascript" src="<?php echo $tmp_path; ?>/form_validator_newsletter.js"></script>
</head>
<body>
<?php
// END OF PAGE HEADER
