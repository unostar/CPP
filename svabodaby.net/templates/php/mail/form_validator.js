...
var fieldRequired = Array("fm_selrecip", "fm_name", "fm_subject", "fm_verify", "fm_message", "recaptcha_response_field");
//2) Enter field description to appear in the dialog box
var fieldDescription = Array("Адправіць куды?", "Ваша імя", "Ваш email", "Тэма паведамлення", "Паверкавы код", "Тэкст паведамлення", "Паверкавы код");
