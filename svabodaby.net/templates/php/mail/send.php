...
$script_path = '/templates/php/mail/send.php';
...
$html_page_title = 'Адправіць ліст';
...
$form_struct = '
  ...
  type=fullblock|class=fmfullblock|text=Калі вы хочаце атрымліваць папяровую версію газеты "Тут і цяпер", дашліце ў рэдакцыю свой паштовы адрас.
  type=fullblock|class=fmfullblock|text=Калі жадаеце атрымліваць электронную рассылку, дашліце на адрас рэдакцыі свой e-mail з удакуладненнем "Для электроннай рассылкі".
  type=selrecip|class=fmselect|label=Адправіць|data=(абярыце),Лiст рэдактару,larysa.shapavalava@gmail.com,Падпiсацца на рассылку,larysa.shapavalava@gmail.com
  type=text|class=fmtext|label=Ваша імя|fieldname=fm_name|max=100|req=true
  type=text|class=fmtext|label=Ваш email|fieldname=fm_email|max=100
  type=text|class=fmtext|label=Тэма|fieldname=fm_subject|max=200|req=true
  ...
  type=file|class=fmfile|label=Файл|fieldname=fm_upload|allowed=jpg,jpeg
  type=closefieldset
';
