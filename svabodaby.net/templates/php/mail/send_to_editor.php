...
$form_struct = '
  type=openfieldset|legend=Адправіць ліст рэдактару
  to=larysa.shapavalava@gmail.com
  type=text|class=fmtext|label=Ваша імя|fieldname=fm_name|max=100|req=true
  type=text|class=fmtext|label=Ваш email|fieldname=fm_email|max=100|ver=email
...
<script type="text/javascript" src="<?php echo $tmp_path; ?>/form_validator_to_editor.js"></script>
</head>
<body>
<?php
// END OF PAGE HEADER
