...
var fieldRequired = Array("fm_name", "fm_email", "fm_subject", "fm_verify", "fm_message", "recaptcha_response_field");
//2) Enter field description to appear in the dialog box
var fieldDescription = Array("Ваша імя", "Ваш email", "Тэма паведамлення", "Паверкавы код", "Тэкст паведамлення", "Паверкавы код");
