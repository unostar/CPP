...
$html = '<ul>';
$i = 0;
$xml = @simplexml_load_file("http://gdata.youtube.com/feeds/api/users/NashaNiva/uploads");
...
if ($xml) {
  ...
  if ( strlen($html) > 512) {file_put_contents("/var/www/xml-forest/video-rss-import-nasha_niva.html", $html);}
}
