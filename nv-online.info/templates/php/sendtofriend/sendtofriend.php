...
";
$subject = "Вы атрымалі артыкул з сайта Рэгіянальнай газеты ".date("d.m.Y");
{{ /php }}
   ...
   {{ php }}
      ...
      if (isset($_POST['login'])) {
         ...
         if (strtoupper($_POST['code']) == $_SESSION['code']) {
            $body = "Привет ".$to_name."
Ваш сябар ".$from_name." прапаноўвае вам прачытаць артыкул на вэбсайце Народная Воля. Перайдзіце па гэтай спасылцы: http://".$link."
