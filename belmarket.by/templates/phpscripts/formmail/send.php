...
$script_path = 'http://www.belmarket.by/templates/phpscripts/formmail/send.php';
...
$path_contact_page = 'http://www.belmarket.by/ru/?tpl=133';
...
$form_struct = '
type=select|class=fmselect|label=Период подписки|fieldname=fm_period|req=true|data=(выберите период),квартал,полгода,год
	type=text|class=fmtext|label=Другой период|fieldname=fm_other|max=100|req=false
	...
	type=textarea|class=fmtext|label=Доп.информация|fieldname=fm_extra|max=1000|rows=6|req=true
	type=verify|class=fmverify|label=Проверочный код
';
...
$email_subject = 'Подписка на pdf-версию';
...
$sent_message = '<p>Спасибо, Ваш запрос успешно отправлен!</p>';
