...
$script_path = 'http://www.belmarket.by/templates/phpscripts/formmail/send-news.php';
...
$recipients = 'slobodan.gogic@mediaonweb.org';
...
$re_public_key = '6LcJLAEAAAAAADgy7kPpMNv5_kM-9oDCphu-c3wp';
$re_private_key = '6LcJLAEAAAAAAHXLmDamcgmrfWnddNGzuyPC3Dg7';
...
";
	...
	if (!$message_sent) {	
		...
		if (trim($manual_form_code) == '') {	// ** Use normal form generation
			...
			$o .= '<form id="myForm" class="ddfm" method="post" action="' . $path_contact_page . '" enctype="multipart/form-data">' . "
...
<link rel="stylesheet" href="<?php echo $path_to_css; ?>" type="text/css" media="screen" />
  <script type="text/javascript" src="look/phpscripts/formmail/sarissa.js"></script>
  <script type="text/javascript" src="look/phpscripts/formmail/util-functions.js"></script>
  ...
  function submitRating(e) {
      ...
      xmlhttp.open('POST', 'send-news.php', true);
