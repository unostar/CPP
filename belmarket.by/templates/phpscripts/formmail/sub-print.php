...
$script_path = 'http://www.belmarket.by/templates/phpscripts/formmail/sub-print.php';
...
$form_struct = '
type=select|class=fmselect|label=Вид|fieldname=fm_typea|req=true|data=(выберите),модульная реклама,строчная реклама
	type=text|class=fmtext|label=Число публикаций|fieldname=fm_other|max=100|req=true
...
$email_subject = 'Заказ рекламы для размещения в печатной версии газеты';
