...
$script_path = 'http://www.belmarket.by/templates/phpscripts/smail/send.php';
...
$form_struct = '
  ...
  type=selrecip|class=fmselect|label=Послать|data=(выберите),Сообщение,sezen@br.minsk.by,Подписка,subscribe@br.minsk.by,Реклама,reklam@br.minsk.by
	...
	type=textarea|class=fmtextarea|label=Сообщение|fieldname=fm_message|max=1000|rows=6|req=true
  type=file|class=fmfile|label=Файл|fieldname=fm_upload|allowed=jpg,jpeg,gif,png,pdf,zip,rar,doc,docx,rtf,txt,xls
  type=closefieldset
';
...
<title>Белорусы и рынок - Написать письмо в редакцию</title>
