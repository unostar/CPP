...
$script_path = 'http://brynok.omniton.net/templates/phpscripts/adsmail/ads-send.php';
...
$form_struct = '
type=text|class=fmtext|label=Фамилия и имя автора статьи|fieldname=fm_name|max=100|req=true
