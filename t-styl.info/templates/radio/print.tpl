...
<meta name="keywords" content="новости,комментарии,вести,рубрики,блоги,статья,экономика,политика,факты,Беларусь,Гродно,навiны" />
<meta name="description" content="Твой стыль (Гародня) - он-лайн навiны"/>
...
<div class="footer">
<p><span class="ts">{{ $gimme->publication->site}}</span>&nbsp;/ Source URL: http://{{ $gimme->publication->site}}{{ uri options="article" }}<br/>&copy; Copyright 2009 Твой Стыль</p>
</div>
</body>
</html>