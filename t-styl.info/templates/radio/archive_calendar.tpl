...
{{ unset_article }}
    {{ unset_topic }}
        <form method="post" action="{{* uri options="template radio/archive_calendar_list.tpl" *}}" name="dates" id="dates">
...
<script type="text/javascript">
  ...
  YAHOO.example.calendar.init = function() {
    function handleSelect(type,args,obj) {
      ...
      var linkTo = '{{ uri options="template radio/archive_calendar_list.tpl" }}&date=' + txtDate1.value;
