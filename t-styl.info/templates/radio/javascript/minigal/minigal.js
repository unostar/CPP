var path = "/templates/radio/javascript/minigal/";

document.write('<link href="'+path+'minigal.css" rel="stylesheet" type="text/css" />');
//document.write('<script type="text/javascript" src="/templates/radio/javascript/jquery.min.js"></script>');
//document.write('<script type="text/javascript" src="/templates/radio/javascript/jquery.scrollable-1.0.2.min.js"></script>');
...
//addLoadEvent(initminigalZoom); // if we want to add to window.onload event, declared below
//addLoadEvent(round_corners);
...
$(function(){$("div.minigal-scrollable").scrollable({size:7,loop:true,interval:0,speed:800,keyboard:true,next:'a.more',prev:'a.less'});});

initminigalZoom();

document.getElementById('minigal-gallery').style.visibility = 'visible';
}
