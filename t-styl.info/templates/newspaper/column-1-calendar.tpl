<div style="width:190px;" class="cal">
<p class="rest-news">Каляндар</p>
...
{{ unset_article }}
    {{ unset_topic }}
        <form method="post" action="{{* uri options="template newspaper/archive-calendar.tpl" *}}" name="dates" id="dates">
...
<!--
  ...
  YAHOO.example.calendar.init = function() {
    function handleSelect(type,args,obj) {
      ...
      var linkTo = '{{ uri options="template newspaper/archive-calendar.tpl" }}&date=' + txtDate1.value;
...
YAHOO.example.calendar.cal1.cfg.setProperty("MONTHS_LONG",    ["студзень", "люты", "сакавiк", "красавiк", "травень", "чэрвень", "лiпень", "жнiвень", "верасень", "каcтрычнiк", "лiстапад", "снежань"]); 
