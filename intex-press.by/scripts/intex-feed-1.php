...
//mirovnie novosti
$rss_file = "http://news.yandex.ru/Russia/index.rss";
...
foreach($rss_feed->channel->item as $item ) {
  if($i++==6)
    break; 
        $content .= "<p class=\"bottom-link\"><a href=\"$item->link\" target=\"_blank\">$item->title</a></p>"
	         . "\n"
                 . "<p class=\"bottom-date\">$time[1] $time[2] $time[3] г.</p>"
	         . "\n";
}
write($content, 'intex-feed-1.html');
?>
