...
//blog rss
$url = "http://elenashostak.wordpress.com/feed/";
$handle = fopen($url, "rb");
$contents = '';
while (!feof($handle)) {
...
foreach($rss_feed->channel->item as $item ) {
  if($i++==1)
    break; 
        $content .= "<h4><strong><a href=\"http://elenashostak.wordpress.com\" target=\"_blank\">$item->creator</a></strong></h4>"
	         . "\n"
...
write($content, 'intex-blog-3.html');
?>