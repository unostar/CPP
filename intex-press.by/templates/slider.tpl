...
<div class="autor-box"> <img src="/get_img.php?{{ urlparameters options="image 1" }}" alt="{{ $gimme->article->image1->description }}" />

            <p class="title">Автор:</p>

            <p>{{ $gimme->article->author }}</p>
          ...
          <p class="autor-date">{{ $gimme->article->publish_date|camp_date_format:"%d %M %Y" }} г.{{ list_article_comments }}{{ if $gimme->current_list->at_beginning }}, комментарии ({{ $gimme->article->comment_count }}){{ /if }}{{ /list_article_comments }}
