...
<body>
<div class="logo">
<a href="/"><img src="/templates/mobile/mobile-logo.gif" width="169" height="31" alt="INTEX-PRESS Online мобильная версия" /></a>
{{$smaty.now|camp_date_format:"<b>%e %M, %Y г.</b><br />%W, %k:%i"}}
</div>
