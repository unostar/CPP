...
<script language="javascript" src="/templates/slonim/javascript/prototype.js"></script>
...
<tr>
  <td valign="top">
    ...
    {{ if $gimme->poll->defined }}
        ...
        {{ include file='slonim/poll-form.tpl' included=true}}
        
        <br>
        <a href="{{ uri options="template slonim/section-polls.tpl" }}">All Polls</a>
    ...
    {{ else }}
        ...
        {{ list_polls name="polls_list" length="10" order='bylastmodified ASC' }}
           <tr align="center">
            <td align="left">
                <a href="{{ uri options="template slonim/section-polls.tpl" }}&amp;f_poll_nr={{ $gimme->poll->number }}&amp;f_poll_language_id={{ $gimme->poll->language_id }}">
                    {{ $gimme->poll->name }}
                </a>
            </td>
