...
{{* start main content *}}
  <div id="main" class="clearfix">
    <div class="column-1">
{{ include file="slonim/section-column-1-top-news.tpl" }}
{{ include file="slonim/section-column-1-section-news.tpl" }}
{{ include file="slonim/section-column-1-other-news.tpl" }}  
