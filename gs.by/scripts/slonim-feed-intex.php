...
//mirovnie novosti
$rss_file = "http://www.intex-press.by:82/feed/index.rss";
...
case ($time[2] == "Dec" || $time[2] == "December"): $time[2] = "декабря"; break;
    ...
    $content .= "<p class=\"link\"><a href=\"$item->link\" target=\"_blank\">$item->title</a> <span>, $time[1] $time[2] $time[3]</span></p>\n";
}

write($content, 'slonim-feed-intex.html');
