...
";
$subject = "У Вас новое сообщение на сайте Борисовкие Новости ".date("d.m.Y");
{{ /php }}
   ...
   {{ php }}
      ...
      if (isset($_POST['login'])) {
         ...
         if (strtoupper($_POST['code']) == $_SESSION['code']) {
            $body = "Привет ".$to_name."
Ваш друг ".$from_name." послал Вам ссылку на сайт Борисовкие Новости. Чтобы прочитать сообщение перейдите по ссылке: http://".$link."
