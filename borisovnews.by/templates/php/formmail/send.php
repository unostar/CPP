...
$script_path = 'http://borisov.omniton.net/templates/php/formmail/send.php';
...
$recipients = 'reklama@borisovnews.com';
...
$form_struct = '
  ...
  type=text|class=fmtext|label=Имя|fieldname=fm_name|max=100|req=true
  ...
  type=verify|class=fmverify|label=Введите код
...
function ddfm_send_mail($recipients, $sender_name, $sender_email, $email_subject, $email_msg, $attachments = false) {
  ...
  $send_status = mail($send_to, "=?UTF-8?B?".base64_encode($email_subject)."?=", $msg, $headers);
...
";
      ...
      $o .= '<div class="credits">' . DDFM_CREDITS . ' <a href="#" title="Dagon Design"></a></div>' . "
